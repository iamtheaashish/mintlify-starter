...
### 2026
[End-To-End Encrypted CLI Secrets Manager]() <Badge color="green" size="sm">Production Ready</Badge>
...
[Dental Clinic ERP](https://github.com/iamtheaashish/DentalClinicERPSystem) <Badge color="green" size="sm">Production Ready</Badge>

**Tech Stack**: ASP.NET Core 10 (MVC), Entity Framework Core, Bootstrap 5, SQL Server
...
+ [OOP Tic-Tac-Toe](https://github.com/iamtheaashish/Tic-Tac-Toe) <Badge color="green" size="sm">Production Ready</Badge>
